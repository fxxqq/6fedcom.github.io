...
// 压缩theme目录下的所有img： 最大化压缩效果。
gulp.task('minify-img-compress-theme', function () {
    return gulp.src('./themes/frank/source/img/**/*.*')
        .pipe(imagemin(
            [imagemin.gifsicle({
                    'optimizationLevel': 3
                }),
        ...
        .pipe(gulp.dest('./themes/frank/source/img'))
})
// cmd back 返回上一层
...
gulp.task('m', function (cb) {
    runSequence('minify-img-compress', 'minify-img-compress-theme', cb)
});